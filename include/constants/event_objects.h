...
// Eien NPCs BEGIN (generated by tools/eien_npcs/convert.py)
    OBJ_EVENT_GFX_EIEN_HARU,
    OBJ_EVENT_GFX_EIEN_AKIRA,
    OBJ_EVENT_GFX_EIEN_NAMI,
    OBJ_EVENT_GFX_EIEN_KASHIWAGI,
    OBJ_EVENT_GFX_EIEN_KASHIWAGI_HUSBAND,
    OBJ_EVENT_GFX_EIEN_FUYUMI,
    OBJ_EVENT_GFX_EIEN_FISHERMAN,
    OBJ_EVENT_GFX_EIEN_SAILOR,
    OBJ_EVENT_GFX_EIEN_VILLAGE_WOMAN,
    OBJ_EVENT_GFX_EIEN_SCHOOLBOY,
    OBJ_EVENT_GFX_EIEN_SNOW_TRAINER,
    OBJ_EVENT_GFX_EIEN_WORKER,
    OBJ_EVENT_GFX_EIEN_POKEFAN_M,
    OBJ_EVENT_GFX_EIEN_SOCIALITE,
// Eien NPCs END
    NUM_OBJ_EVENT_GFX,
};
...
// Eien NPCs palette tags BEGIN (generated by tools/eien_npcs/convert.py)
#define OBJ_EVENT_PAL_TAG_EIEN_NPC_1    0x1180
#define OBJ_EVENT_PAL_TAG_EIEN_NPC_2    0x1181
#define OBJ_EVENT_PAL_TAG_EIEN_NPC_3    0x1182
#define OBJ_EVENT_PAL_TAG_EIEN_NPC_4    0x1183
// Eien NPCs palette tags END

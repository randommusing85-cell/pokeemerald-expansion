...
// NPC_YoungMan.png (HGSS OWs in FR style: Delta231, Mimi, M.vit, Kimoras)
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienHaru = {
    .tileTag = TAG_NONE,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienKashiwagi = {
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienKashiwagi,
};

// NPC_Shopkeeper.png (HGSS OWs in FR style: Delta231, Mimi, M.vit, Kimoras)
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienKashiwagiHusband = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_EIEN_NPC_1,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienKashiwagiHusband,
};

// trainer_ACETRAINER_F.png (HGSS OWs in FR style: Delta231, Mimi, M.vit, Kimoras)
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienFuyumi = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_EIEN_NPC_2,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienFuyumi,
};

// trainer_FISHERMAN.png (HGSS OWs in FR style: Delta231, Mimi, M.vit, Kimoras)
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienFisherman = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_EIEN_NPC_1,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienFisherman,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienVillageWoman = {
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienVillageWoman,
};

// trainer_SCHOOLBOY.png (FRLG-style RSE NPCs: Poffin_Case)
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienSchoolboy = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_EIEN_NPC_4,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienSchoolboy,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienSnowTrainer = {
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienSnowTrainer,
};

// trainer_WORKER.png (DPPt NPCs: artist not named in the pack readme)
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienWorker = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_EIEN_NPC_3,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_EienWorker,
};

// trainer_POKEFAN_M.png (FRLG-style RSE NPCs: Poffin_Case)
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienPokefanM = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_EIEN_NPC_1,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,

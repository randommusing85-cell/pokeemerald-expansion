...
#endif // IS_FRLG
// Eien NPCs BEGIN (generated by tools/eien_npcs/convert.py)
static const struct SpriteFrameImage sPicTable_EienHaru[] = {
    overworld_ascending_frames(gObjectEventPic_EienHaru, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienAkira[] = {
    overworld_ascending_frames(gObjectEventPic_EienAkira, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienNami[] = {
    overworld_ascending_frames(gObjectEventPic_EienNami, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienKashiwagi[] = {
    overworld_ascending_frames(gObjectEventPic_EienKashiwagi, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienKashiwagiHusband[] = {
    overworld_ascending_frames(gObjectEventPic_EienKashiwagiHusband, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienFuyumi[] = {
    overworld_ascending_frames(gObjectEventPic_EienFuyumi, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienFisherman[] = {
    overworld_ascending_frames(gObjectEventPic_EienFisherman, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienSailor[] = {
    overworld_ascending_frames(gObjectEventPic_EienSailor, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienVillageWoman[] = {
    overworld_ascending_frames(gObjectEventPic_EienVillageWoman, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienSchoolboy[] = {
    overworld_ascending_frames(gObjectEventPic_EienSchoolboy, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienSnowTrainer[] = {
    overworld_ascending_frames(gObjectEventPic_EienSnowTrainer, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienWorker[] = {
    overworld_ascending_frames(gObjectEventPic_EienWorker, 2, 4),
};

static const struct SpriteFrameImage sPicTable_EienPokefanM[] = {
    overworld_ascending_frames(gObjectEventPic_EienPokefanM, 2, 4),
};

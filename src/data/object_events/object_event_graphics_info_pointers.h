...
// Eien NPCs externs BEGIN (generated by tools/eien_npcs/convert.py)
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienHaru;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienAkira;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienNami;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienKashiwagi;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienKashiwagiHusband;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienFuyumi;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienFisherman;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienSailor;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienVillageWoman;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienSchoolboy;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EienSnowTrainer;
...
#endif // IS_FRLG// Eien NPCs BEGIN (generated by tools/eien_npcs/convert.py)
    [OBJ_EVENT_GFX_EIEN_HARU] = &gObjectEventGraphicsInfo_EienHaru,
    [OBJ_EVENT_GFX_EIEN_AKIRA] = &gObjectEventGraphicsInfo_EienAkira,
    [OBJ_EVENT_GFX_EIEN_NAMI] = &gObjectEventGraphicsInfo_EienNami,
    [OBJ_EVENT_GFX_EIEN_KASHIWAGI] = &gObjectEventGraphicsInfo_EienKashiwagi,
    [OBJ_EVENT_GFX_EIEN_KASHIWAGI_HUSBAND] = &gObjectEventGraphicsInfo_EienKashiwagiHusband,
    [OBJ_EVENT_GFX_EIEN_FUYUMI] = &gObjectEventGraphicsInfo_EienFuyumi,
    [OBJ_EVENT_GFX_EIEN_FISHERMAN] = &gObjectEventGraphicsInfo_EienFisherman,
    [OBJ_EVENT_GFX_EIEN_SAILOR] = &gObjectEventGraphicsInfo_EienSailor,
    [OBJ_EVENT_GFX_EIEN_VILLAGE_WOMAN] = &gObjectEventGraphicsInfo_EienVillageWoman,
    [OBJ_EVENT_GFX_EIEN_SCHOOLBOY] = &gObjectEventGraphicsInfo_EienSchoolboy,
    [OBJ_EVENT_GFX_EIEN_SNOW_TRAINER] = &gObjectEventGraphicsInfo_EienSnowTrainer,
